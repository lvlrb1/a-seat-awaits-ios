...
struct QRCodeView: View {
    ...
    var body: some View {
        ...
        // On iPad, present as a form sheet — the QR card is a fixed 288pt
        // square and looks lost in a near-fullscreen page sheet.
    ...
    @ViewBuilder private var qrSection: some View {
        ...
        case .disabled:
            notice(icon: "lock.fill",
                   ...
                   message: "Previously shared codes and links no longer work for this event.")
